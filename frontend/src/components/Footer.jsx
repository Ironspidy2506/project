      ...
      <div className="content">
        ...
        <div>
          ...
          <div>
            ...
            <a href="tel:+919724055969" className="contact-info">+91 97240 55969</a>
          </div>
          <div>
            <FaEnvelope className="contact-icon" />
            <a href="mailto:priyanshusahu@gmail.com" aria-label="Mail" target="_blank" rel="noopener noreferrer" className="contact-info">
            priyanshusahu@gmail.com
            </a>
          </div>
          <div>
